...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2023 at 07:20 PM
...
(1, 'tripti', 'kharole', 'triptikharole@gmail.com', 2147483647, 'hey');
...
(2, 1, 0, 'iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii'),
(3, 1, 0, 'hhhhhhhhhhhhhhhhhhhh'),
(4, 1, 0, 'hhhhhhhhhhh'),
(5, 2, 0, 'j'),
(6, 2, 1, 'u'),
(7, 2, 0, 'h'),
...
INSERT INTO `questions` (`question_number`, `question_text`, `question_language`) VALUES
(1, 'html full form?', ''),
(2, 'jfjijfe', ''),
(3, 'hhd', ''),
(4, 'html full form?', ''),
...
(120, 'What is the purpose of the ', 'To prevent a variable from being modified', 'To indicate the end of a loop', 'To mark a method as private', 'To declare a class as abstract', 1, 'Java');
...
INSERT INTO `quize` (`id`, `questions`, `answers`, `aid`) VALUES
(0, 'what is the full form of HTML?', 'ujsiuis2q2qj', 1);
...
(0, 'HTML', 'HTML is a hypertext markup language .Which is used in website development');
